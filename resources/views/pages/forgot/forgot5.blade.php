   ...
   <div class="login-forgot">
						...
						<form class="form" id="kt_login_forgot_form">
							...
							<div class="form-group">
								...
								<button type="button" id="kt_login_forgot_cancel" onclick="window.location.href='login5'" class="btn btn-pill btn-outline-white font-weight-bold opacity-70 px-15 py-3 m-2">Cancel</button>
							</div>
						</form>
					</div>
