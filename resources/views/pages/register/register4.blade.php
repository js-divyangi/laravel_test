        ...
        <div class="login-signup">
				...
				<form class="form text-center" id="kt_login_signup_form">
					...
					<div class="form-group">
						...
						<button type="button" id="kt_login_signup_cancel" onclick="window.location.href='login4'" class="btn btn-pill btn-outline-white opacity-70 px-15 py-3 m-2">Cancel</button>
					</div>
				</form>
			</div>
