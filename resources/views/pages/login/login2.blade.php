                ...
                <div class="login-form login-signin py-11">
                    ...
                    <form class="form" novalidate="novalidate"  id="kt_login_signin_form">
                        ...
                        <div class="text-center pb-8">
                            ...
                            <span class="text-muted font-weight-bold font-size-h4">Or <a href="register2" class="text-primary font-weight-bolder" id="kt_login_signup">Create An Account</a></span>
                        </div>
                        <!--end::Title-->
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between mt-n5">
                                ...
                                <a href="forgot2" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5" id="kt_login_forgot">
            						Forgot Password ?
            					</a>
                            </div>
