			...
			<div class="login-signin">
				...
				<form class="form" id="kt_login_signin_form">
					...
					<div class="form-group d-flex flex-wrap justify-content-between align-items-center px-8 opacity-60">
						...
						<a href="forgot4" id="kt_login_forgot" class="text-white font-weight-bold">Forget Password ?</a>
					</div>
				...
				<div class="mt-10">
					...
					<a href="register4" id="kt_login_signup" class="text-white opacity-30 font-weight-normal">Sign Up</a>
				</div>
			</div>
